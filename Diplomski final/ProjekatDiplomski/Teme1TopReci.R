...
process_topic <- function(data, topic_name, num_topics = 5) {  # Postavljeno na najmanje 2
...
process_topic(sport, "sport",2)
process_topic(umetnost, "umetnost",2)
process_topic(tehnologija, "tehnologija",2)
process_topic(priroda, "priroda",2)
process_topic(drustvo, "drustvo",2)
